return {
	...
	config = function()
		...
		-- LSP keymaps
		vim.keymap.set("n", "<Leader>.", "<Cmd>lua vim.lsp.buf.definition()<CR>", { noremap = true, silent = true })
		vim.keymap.set("n", "<Leader>,", "<Cmd>lua vim.lsp.buf.declaration()<CR>", { noremap = true, silent = true })
		vim.keymap.set("n", "<Leader>;", "<Cmd>lua vim.lsp.buf.implementation()<CR>", { noremap = true, silent = true })
		vim.keymap.set("n", "<Leader>r", "<Cmd>lua vim.lsp.buf.rename()<CR>", { noremap = true, silent = true })
		vim.keymap.set("n", "<Leader>c", "<Cmd>lua vim.lsp.buf.code_action()<CR>", { noremap = true, silent = true })
